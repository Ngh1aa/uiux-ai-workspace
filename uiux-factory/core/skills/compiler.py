...
class SkillInstructionCompiler:
    ...
    STAGE_FOCUS: dict[str, tuple[str, ...]] = {
        ...
        "research": ("research", "evidence", "source", "benchmark", "discovery", "audience", "unknown"),
        "ux_ia": ("journey", "task", "architecture", "navigation", "hierarchy", "findability", "page"),
        "art_direction": ("visual", "layout", "hierarchy", "brand", "type", "color", "media", "signature"),
        ...
        "browser_qa": ("test", "browser", "visual", "responsive", "accessibility", "evidence", "performance"),
